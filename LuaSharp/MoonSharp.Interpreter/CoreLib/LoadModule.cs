...
function(modulename)
	...
	return res;
            ...
            Table defaultEnv)
        {
            ...
            {
                var S = executionContext.GetScript();
                var filename = args.AsType(0, "loadfile", DataType.String, false);
        ...
        public static DynValue dofile(ScriptExecutionContext executionContext, CallbackArguments args)
        {
            ...
            {
                var S = executionContext.GetScript();
                var v = args.AsType(0, "dofile", DataType.String, false);
        ...
        {
            var S = executionContext.GetScript();
            var v = args.AsType(0, "__require_clr_impl", DataType.String, false);
