...
namespace MoonSharp.Interpreter.CoreLib
{
    ...
    public class MathModule
    {
        ...
        {
            var arg = args.AsType(0, funcName, DataType.Number, false);
        ...
        {
            var arg = args.AsType(0, funcName, DataType.Number, false);
            var arg2 = args.AsType(1, funcName, DataType.Number, false);
        ...
        public static DynValue frexp(ScriptExecutionContext executionContext, CallbackArguments args)
        {
            ...
            var arg = args.AsType(0, "frexp", DataType.Number, false);
        ...
        {
            var arg = args.AsType(0, "modf", DataType.Number, false);
