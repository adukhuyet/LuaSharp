...
namespace MoonSharp.Interpreter.CoreLib
{
    ...
    {
        private static readonly uint[] BITS =
        {
            0x1, 0x2, 0x4, 0x8,
            0x10, 0x20, 0x40, 0x80,
        ...
        {
            var accum = ToUInt32(args.AsType(0, funcName, DataType.Number, false));

            for (var i = 1; i < args.Count; i++)
            {
                var vv = ToUInt32(args.AsType(i, funcName, DataType.Number, false));
