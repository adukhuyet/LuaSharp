...
namespace MoonSharp.Interpreter.CoreLib
{
    ...
    public class IoModule
    {
        ...
        {
            var filename = args.AsType(0, "lines", DataType.String, false).String;
            ...
            try
            {
                ...
                using (
                    var stream = Script.GlobalOptions.Platform.IO_OpenFile(executionContext.GetScript(), filename, null,
                        "r"))
                {
        ...
        {
            var filename = args.AsType(0, "open", DataType.String, false).String;
