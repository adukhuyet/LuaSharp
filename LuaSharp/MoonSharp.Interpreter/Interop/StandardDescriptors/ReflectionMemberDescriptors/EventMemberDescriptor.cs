...
namespace MoonSharp.Interpreter.Interop
{
    ...
    public class EventMemberDescriptor : IMemberDescriptor
    {
        ...
        private readonly MultiDictionary<object, Closure> m_Callbacks =
            new MultiDictionary<object, Closure>(new ReferenceEqualityComparer());

        private readonly Dictionary<object, Delegate> m_Delegates =
            new Dictionary<object, Delegate>(new ReferenceEqualityComparer());
        ...
        private DynValue AddCallback(object o, ScriptExecutionContext context, CallbackArguments args)
        {
            ...
            {
                var closure =
                    args.AsType(0, string.Format("userdata<{0}>.{1}.add", EventInfo.DeclaringType, EventInfo.Name),
        ...
        private DynValue RemoveCallback(object o, ScriptExecutionContext context, CallbackArguments args)
        {
            ...
            {
                var closure =
                    args.AsType(0, string.Format("userdata<{0}>.{1}.remove", EventInfo.DeclaringType, EventInfo.Name),
                        DataType.Function, false).Function;
        ...
        private Delegate CreateDelegate(object sender)
        {
            switch (EventInfo.EventHandlerType.GetMethod("Invoke").GetParameters().Length)
            {
                ...
                case 7:
                    return
                        (EventWrapper07)
                            ((o1, o2, o3, o4, o5, o6, o7) => DispatchEvent(sender, o1, o2, o3, o4, o5, o6, o7));
                case 8:
                    return
                        (EventWrapper08)
                            ((o1, o2, o3, o4, o5, o6, o7, o8) => DispatchEvent(sender, o1, o2, o3, o4, o5, o6, o7, o8));
                case 9:
                    return
                        (EventWrapper09)
        ...
        internal class EventFacade : IUserDataType
        {
            ...
            private readonly EventMemberDescriptor m_Parent;
        ...
        private delegate void EventWrapper13(
            object o1, object o2, object o3, object o4, object o5, object o6, object o7, object o8, object o9,
            object o10, object o11, object o12, object o13);
        ...
        private delegate void EventWrapper16(
            object o1, object o2, object o3, object o4, object o5, object o6, object o7, object o8, object o9,
            object o10, object o11, object o12, object o13, object o14, object o15, object o16);
    }
}