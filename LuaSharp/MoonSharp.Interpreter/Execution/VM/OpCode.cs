namespace MoonSharp.Interpreter.Execution.VM
{
    internal enum OpCode
    {
        ...
        Closure,
        // Creates a closure on the top of the v-stack, using the symbols for upvalues and num-val for entry point of the function.
        ...
        JFor,
        // Peeks at the top, top-1 and top-2 values of the v-stack which it assumes to be numbers. Then if top-1 is less than zero, checks if top is <= top-2, otherwise it checks that top is >= top-2. Then if the condition is false, it jumps.
        JtOrPop,
        // Peeks at the topmost value of the v-stack as a boolean. If true, it performs a jump, otherwise it removes the topmost value from the v-stack.
        JfOrPop,
        // Peeks at the topmost value of the v-stack as a boolean. If false, it performs a jump, otherwise it removes the topmost value from the v-stack.
        ...
        CNot,
        // Conditional NOT - takes second operand from the v-stack (must be bool), if true execs a NOT otherwise execs a TOBOOL
        ...
        Incr,
        // Performs an add operation, without extracting the operands from the v-stack and assuming the operands are numbers.
        ...
        // Meta
        Invalid
        // Crashes the executor with an unrecoverable NotImplementedException. This MUST always be the last opcode in enum
    }
}