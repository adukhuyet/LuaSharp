...
namespace MoonSharp.Interpreter.Execution.VM
{
    internal class ByteCode : RefIdObject
    {
        ...
        {
            return
                AppendInstruction(new Instruction(m_CurrentSourceRef) {OpCode = OpCode.ExpTuple, NumVal = stackOffset});
        }
        ...
        {
            return
                AppendInstruction(new Instruction(m_CurrentSourceRef) {OpCode = OpCode.Swap, NumVal = p1, NumVal2 = p2});
        }
